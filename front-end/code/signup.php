...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <main class="container text-center my-5">
        <section>
        <h3 style="font-size: 80px;">Signup</h3>
        </section>

        <p id="error-message"></p>

        <form action="process-signup.php" method="post" id="signup" class="mx-auto" novalidate style="max-width: 400px;">
          <div>
        ...
        <p class="textAccount">Already have an account?<a href="login.php">Login</a></p>
    </main>
